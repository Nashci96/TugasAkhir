...
public class AdmVerSemhasModel {

    String nama,nobp,judul,nip_pbb_1,nip_pbb_2, nama_pbb_1, nama_pbb_2,nip_pgj_1,nip_pgj_2, nama_pgj_1, nama_pgj_2,tgl,shift;



    public AdmVerSemhasModel(String namaMhs, String noBp, String judulTA, String nama_pbb_1, String nama_pbb_2, String nama_pgj_1,
