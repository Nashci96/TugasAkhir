...
public class DsnSemhasAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsn_semhas2);
        ...
        namaMhs = findViewById(R.id.tv_DsnSemhasLayout_Nama);
        noBp = findViewById(R.id.tv_DsnSemhasLayout_BP);
        judulTA = findViewById(R.id.tv_DsnSemhas_judul_desc);
        nama_pgj_1 = findViewById(R.id.tv_DsnSemhas_pgj1_desc);
        nama_pgj_2 = findViewById(R.id.tv_DsnSemhas_pgj2_desc);
        nama_pbb_1 = findViewById(R.id.tv_DsnSemhas_pbb1_desc);
        nama_pbb_2 = findViewById(R.id.tv_DsnSemhas_pbb2_desc);
        tgl = findViewById(R.id.tv_DsnSemhas_tgl_desc);
        shift = findViewById(R.id.tv_DsnSemhas_shift_desc);
