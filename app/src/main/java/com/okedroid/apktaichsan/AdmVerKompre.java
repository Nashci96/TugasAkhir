...
public class AdmVerKompre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adm_ver_kompre);
        ...
        namaMhs = findViewById(R.id.tv_AdmVerKompreLayout_Nama);
        noBp = findViewById(R.id.tv_AdmVerKompreLayout_BP);
        judulTA = findViewById(R.id.tv_AdmVerKompre_judul_desc);
        nama_pgj_1 = findViewById(R.id.tv_AdmVerKompre_pgj1_desc);
        nama_pgj_2 = findViewById(R.id.tv_AdmVerKompre_pgj2_desc);
        nama_pbb_1 = findViewById(R.id.tv_AdmVerKompre_pbb1_desc);
        nama_pbb_2 = findViewById(R.id.tv_AdmVerKompre_pbb2_desc);
        tgl = findViewById(R.id.tv_AdmVerKompre_tgl_desc);
        shift = findViewById(R.id.tv_AdmVerKompre_shift_desc);
        bVer = findViewById(R.id.bAdmVerKompre);
    ...
    private void verKompre() {
        final String nobp   =   this.noBp.getText().toString().trim();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL.VerRegKompre,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(AdmVerKompre.this, "Success!", Toast.LENGTH_LONG).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(AdmVerKompre.this, "Error : " + e.toString(), Toast.LENGTH_LONG).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(AdmVerKompre.this, "Error : " + error.toString(), Toast.LENGTH_LONG).show();
                    }
                })
        {
            @Override
